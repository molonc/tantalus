# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2017-08-21 22:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('library_id', models.CharField(max_length=50, unique=True, verbose_name='Library ID')),
                ('library_type', models.CharField(choices=[('exome', 'Bulk Whole Exome Sequence'), ('wgs', 'Bulk Whole Genome Sequence'), ('sc_wgs', 'Single Cell Whole Genome Sequence'), ('rnaseq', 'Bulk RNA-Seq'), ('sc_rnaseq', 'Single Cell RNA-Seq')], max_length=50, verbose_name='Library Type')),
                ('index_format', models.CharField(choices=[('D', 'Dual Index (i7 and i5)'), ('N', 'No Indexing')], max_length=50, verbose_name='Index format')),
            ],
        ),
        migrations.CreateModel(
            name='DNASequences',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('new_filename', models.CharField(max_length=500, verbose_name='New Filename')),
                ('running', models.BooleanField(default=False, verbose_name='Running')),
                ('finished', models.BooleanField(default=False, verbose_name='Finished')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('library_id', models.CharField(db_index=True, max_length=50, verbose_name='Library ID')),
                ('library_type', models.CharField(choices=[('exome', 'Bulk Whole Exome Sequence'), ('wgs', 'Bulk Whole Genome Sequence'), ('sc_wgs', 'Single Cell Whole Genome Sequence'), ('rnaseq', 'Bulk RNA-Seq'), ('sc_rnaseq', 'Single Cell RNA-Seq')], max_length=50, verbose_name='Library Type')),
                ('index_format', models.CharField(choices=[('D', 'Dual Index (i7 and i5)'), ('N', 'No Indexing')], max_length=50, verbose_name='Index format')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_id', models.CharField(db_index=True, max_length=50, verbose_name='Sample ID')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compression', models.CharField(choices=[('gzip', 'gzip'), ('bzip2', 'bzip2'), ('none', 'none')], max_length=50, verbose_name='Compression')),
                ('default_filename', models.CharField(max_length=500, verbose_name='Default Filename')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='deployment',
            name='file_transfers',
            field=models.ManyToManyField(to='tantalus.FileTransfer', verbose_name='File Transfers'),
        ),
        migrations.AddField(
            model_name='deployment',
            name='from_storage',
