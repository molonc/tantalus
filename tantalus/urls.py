...
urlpatterns = [
    ...
    url(r'^samples/create/(?P<patient_id>.{1,20})$',
        tantalus.views.SpecificSampleCreate.as_view(),
        name='specific-sample-add'),
    url(r'^samples/confirm-samples-create$',
        tantalus.views.ConfirmSamplesCreate.as_view(),
        name='confirm-samples-create'),
    ...
    url(r'^export-sample-create-template/$',
        tantalus.views.export_sample_create_template,
        name='export-sample-create-template'),
    ...
    url(r'^tags/detail/(?P<pk>\d+)/deletedataset/(?P<pk_2>[0-9]+)$',
        tantalus.views.TagDatasetDelete.as_view(),
        name='tag-dataset-delete'),
    url(r'^tags/detail/(?P<pk>\d+)/deleteresults/(?P<pk_2>[0-9]+)$',
        tantalus.views.TagResultsDelete.as_view(),
        name='tag-results-delete'),
    ...
    url(r'^patients/confirm-patient-edit-from-create$',
        tantalus.views.ConfirmPatientEditFromCreate.as_view(),
        name='confirm-patient-edit-from-create'),
    url(r'^export-patient-create-template/$',
        tantalus.views.export_patient_create_template,
        name='export-patient-create-template'),
    ...
    url(r'^submissions/create/(?P<sample_pk>.{1,20})$',
        tantalus.views.SpecificSubmissionCreate.as_view(),
        name='specific-submission-add'),
